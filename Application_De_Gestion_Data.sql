...
QString sonNumero=ui->combo
QString textRequete="select fzefhzeuiofhzei"
QSqlQuery reqProdDuRayon(textRequete)

ui->tableWidgetProduit->setRowCount(0)

while(reqProdDuRayon.next())
{
	QTableWidgetItem itemLibelle()
}